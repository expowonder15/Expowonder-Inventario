...
<div class="header">
  ...
  <p>Control de inventario de flores <span style="opacity:.6">v2.1</span></p>
</div>
<div class="tabs">
...
function renderStock(data) {
  ...
  data.forEach(f => {
    ...
    html += `<tr><td style="${estilo}">${f.nombre}</td><td style="color:#888;font-size:11px">${f.categoria}</td><td style="text-align:center;${estilo}">${f.stock_ramos}</td><td style="text-align:center">${f.stock_tallos}</td></tr>`;
  });
  html += "</table>";
  div.innerHTML = html;
}
